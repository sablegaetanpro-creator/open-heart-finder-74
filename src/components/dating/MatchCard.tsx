...
const MatchCard: React.FC<MatchCardProps> = ({ match, onMatchClick }) => {
  return (
    <Card 
...
// Fonctions utilitaires (à déplacer dans un fichier séparé si utilisé ailleurs)
const formatLastMessage = (message: any) => {
  if (!message) return 'Commencez la conversation...';
  
  const isOwn = message.sender_id === localStorage.getItem('user_id'); // À adapter avec le contexte
